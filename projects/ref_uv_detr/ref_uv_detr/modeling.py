...
reference path that can only affect decoder queries through aligned, query-level
tokens.  That is the main guardrail against the raw white image polluting UV
fluorescence semantics.
"""
